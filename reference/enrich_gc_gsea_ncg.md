...
Performs glycan-centric Network of Cancer Genes (NCG) Gene Set
Enrichment Analysis (GSEA). It ranks proteins within each glycan trait
separately, then compares enriched cancer gene sets across traits by
...
[`clusterProfiler::compareCluster()`](https://rdrr.io/pkg/clusterProfiler/man/compareCluster.html),
[`DOSE::gseNCG()`](https://rdrr.io/pkg/DOSE/man/gseNCG.html)
