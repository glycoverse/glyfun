...
then performs GO ORA analysis with
...
(e.g. GO) on these proteins. This is what all the enrichment functions
in glystats do (e.g.
...
questions like “Which functions are enriched in proteins with
