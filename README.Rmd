...
`glyfun` provides functional enrichment analysis for glycoproteomics data.
It provides two sets of functions, answering different questions:
...
with common databases including GO, KEGG, Reactome, WikiPathways, DO (Disease Ontology), and NCG (Network of Cancer Genes).
...
You can install the latest release of glyfun from [r-universe](https://glycoverse.r-universe.dev/glyfun) (**recommended**):
