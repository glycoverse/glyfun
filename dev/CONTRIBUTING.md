# Contributing to glyfun

This outlines how to propose a change to glyfun. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("glycoverse/glyfun", fork = TRUE)`.
...
Please note that the glyfun project is released with a [Contributor Code
of Conduct](https://glycoverse.github.io/glyfun/dev/CODE_OF_CONDUCT.md).
